...
public class Logic 
    ...
    */
    ...
    public double calculate(int size, int count) {
        ...
        double burth_count = 0;
        for(int n=0; n<count;n++)
        {
            Set<Integer> arr = new HashSet<>();//для добавления дня рождения

            for(int n_n = 0 ; n_n<size ; n_n++)
            {

               int flag = rnd.nextInt(365);
